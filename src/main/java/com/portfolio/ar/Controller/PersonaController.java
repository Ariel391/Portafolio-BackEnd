...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody PersonaDto dtopersona) {
        ...
        Persona persona = new Persona(
                dtopersona.getNombre(), dtopersona.getApellido(), dtopersona.getTitulo(),
                dtopersona.getSobreMi(), dtopersona.getImg(), dtopersona.getBanner()
        );
